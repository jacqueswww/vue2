## [6.4.5](https://github.com/lastboy/vue2/releases/tag/6.4.4-patch.0) (2025-07-23)

### Security Fixes

* **compiler:** patched ReDoS vulnerability in `parseHTML` regex ([CVE-2024-9506](https://github.com/advisories/GHSA-5j4c-8p2g-v4jx))  
  Malicious nested closing tags like `<script> </</</<... </script>` caused exponential parsing time.  
  The regex responsible for tag name matching has been replaced with a safe alternative that avoids catastrophic backtracking.
