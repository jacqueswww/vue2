;(function (global, factory) {
  ...
  function renderAttr(key, value) {
    if (isBooleanAttr(key)) {
      ...
      return ' '
        .concat(key, '="')
        .concat(escape(convertEnumeratedValue(key, value)), '"')
  ...
  ***************************************************************************** */
      ...
      var _loop_1 = function () {
        ...
        switch (lastState.type) {
          ...
          case 'Fragment':
            ...
            if (rendered < total) {
              return {
                value: this_1.renderNode(children[rendered], false, this_1)
              }
            } else {
  ...
  var normalizeRender = function (vm) {
    ...
    if (isUndef(render)) {
      if (template) {
        ...
        throw new Error(
          'render function or template not defined in component: '.concat(
  ...
  function renderComponent(node, isRoot, context) {
    ...
    if (isDef(getKey) && isDef(cache) && isDef(name)) {
      ...
      if (isDef(getKey) && isUndef(cache)) {
        warnOnce(
          '[vue-server-renderer] Component '.concat(
  ...
  function createBasicRenderer(_a) {
    var _b = _a === void 0 ? {} : _a,
      _c = _b.modules,
      modules = _c === void 0 ? [] : _c,
      _d = _b.directives,
      directives = _d === void 0 ? {} : _d,
      _e = _b.isUnaryTag,
      isUnaryTag =
        _e === void 0
          ? function () {
